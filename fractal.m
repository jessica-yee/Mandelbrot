...
row = linspace(-0.748766713922161, -0.748766707771757, 2000);
% array to span imaginary-range
col = linspace(0.123640844894862, 0.123640851045266, 2000);
% I will store the real parts and imaginary parts of c in separate 20000x20000
% arrays. 
[c_re, c_im] = meshgrid(row, col);
% These will be 20000x20000x500-dimensional tensors that will store the
% trajectory for every point in the grid.
re_prev = zeros(2000, 2000);
im_prev = zeros(2000, 2000);
re = zeros(2000, 2000);
im = zeros(2000, 2000);
div = int16(zeros(2000, 2000));
...
print(f2,'mandelbrot.png','-dpng','-r1000');
